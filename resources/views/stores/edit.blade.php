...
<div class="main-content-wrap">
    ...
    <div class="flex items-center flex-wrap justify-between gap20 mb-27">
        ...
        <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
            ...
            <li><i class="icon-chevron-right"></i></li>
            <li><div class="text-tiny">Edit Toko</div></li>
        </ul>
    </div>
    ...
    <div class="wg-box max-w-2xl mx-auto">
        <div class="title-box mb-6">
            ...
            <div class="body-text">
                Ubah informasi toko di bawah ini. Pastikan data yang dimasukkan sudah benar.
            </div>
        </div>
        ...
        <form action="{{ route('stores.update', $store->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="address" 
                          id="address" 
                          rows="3" 
                          class="form-control w-full">{{ old('address', $store->address) }}</textarea>
                @error('address')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex items-center justify-between pt-4">
                ...
                <button type="submit" class="tf-button style-1">
                    <i class="icon-save"></i> Update Toko
                </button>
            </div>
        </form>
    </div>
